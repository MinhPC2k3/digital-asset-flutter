  ...
  void didChangeDependencies() {
    ...
    if (!_isInit) {
      ...
      WidgetsBinding.instance.addPostFrameCallback((_) async {
        await Provider.of<user_model.UserProvider>(context, listen: false).alreadyLogin(context);
        // Code here runs AFTER fetchUserOnce() finishes
        print("fetchUserOnce completed");
      });
    }
  }
