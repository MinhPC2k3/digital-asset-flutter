...
import 'package:digital_asset_flutter/component/asset_type_selector.dart';
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Row(
                                  children: [
                                    Text(
                                      '\$${_calculateBalance(assetBalancesListenChange).toStringAsFixed(2)}',
                                      style: TextStyle(
                                        color: Colors.white,
                                        fontSize: 36,
                    ...
                    ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        return AssetCard(
                          ...
                          assetBalance: weiToEth(assetBalancesNotListenChange[index].assetBalance),
                          lastChange: assetBalancesNotListenChange[index].last24hChange,
                        );
                      },
                    ),
