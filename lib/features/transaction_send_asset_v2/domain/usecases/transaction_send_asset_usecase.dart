...
class TransactionSendAssetUsecase {
  TransactionSendAssetUsecase({required TransactionSendAssetRepository repository})
    : _transactionRepository = repository;

  final TransactionSendAssetRepository _transactionRepository;
